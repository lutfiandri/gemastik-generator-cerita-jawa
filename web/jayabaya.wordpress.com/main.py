...
def get_story_urls():
    main_urls = [
        "https://jayabaya.wordpress.com/category/crita-rakyat/",
        "https://jayabaya.wordpress.com/category/crita-wayang/",
        "https://jayabaya.wordpress.com/category/sejarah/",
        "https://jayabaya.wordpress.com/category/dongeng/",
    ]
    ...
    for url in main_urls:
        ...
        if response.status_code == 200:
            ...
            elements = soup.select("div#content h2 a")
    ...
    for url in story_urls:
        ...
        if response.status_code == 200:
            ...
            for i, element in enumerate(elements):
                # ignore last 2 paragraph -> writer statement
                if i >= len(elements)-2:
                    continue
...
with open('jayabaya.json', 'w+') as f_json:
